  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      try {
        ...
        // Check for suspension/rejection messages
        let errorMessage = "Error saving user data";
        ...
        if (dbError.response && dbError.response.data) {
          if (dbError.response.data.message) {
            ...
            // Check for rejection/suspension reason
            if (dbError.response.data.reason) {
              errorDetails = dbError.response.data.reason;
            }
          }
        }
        
        // Display error with detailed reason if available
        if (errorDetails) {
