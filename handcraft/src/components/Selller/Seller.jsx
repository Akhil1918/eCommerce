...
const SellerDashboard = () => {
  ...
  return (
    <div className="bg-gray-50 p-6 dark:bg-gray-900 min-h-screen">
      ...
      {/* Recent Orders */}
            <div className="bg-white p-6 rounded-lg shadow-sm dark:bg-gray-800">
              <h3 className="text-gray-800 text-lg dark:text-white font-semibold mb-4">Recent Orders</h3>
          ...
          <table className="text-left w-full">
            ...
            <tbody>
              {dashboardData.recentOrders.map((order) => (
                        <tr key={order.id} className="border-b dark:border-gray-700 dark:hover:bg-gray-800/50 hover:bg-gray-50">
                  ...
                  <td className="p-3">
                      ...
                      {order.status}
                          ...
                          <td className="p-3">
                            <button className="text-indigo-600 dark:hover:text-indigo-300 dark:text-indigo-400 hover:text-indigo-800">
                              View Details
                            </button>
                          </td>
                </tr>
